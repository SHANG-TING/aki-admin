...
export const ScreeningsRow = styled((props) => <Row {...props} />)<ScreeningsRowProps>`
  cursor: pointer;
...
export const Avatar = styled((props) => <AntAvatar {...props} />)<Importance>`
  position: relative;
...
export const Name = styled((props) => <Typography.Text {...props} />)<Importance>`
  white-space: nowrap;
...
export const Percentage = styled((props) => <Typography.Text {...props} />)<PercentageProps>`
  font-size: ${FONT_SIZE.xs};
