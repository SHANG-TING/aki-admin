...
export const PlusIcon = styled((props) => <PlusCircleFilled {...props} />)`
  color: var(--lightgrey);
  font-size: 1.5625rem;
  margin-right: 1rem;
`;
...
export const Input = styled((props) => <AntInput {...props} />)`
  height: 3.125rem;
  border: none;
  background: var(--secondary-background-color);
  border-radius: 3.125rem;
...
export const RangePicker = styled((props) => (
  <DayjsDatePicker.RangePicker {...props} />
))`
  width: 100%;
...
export const PopoverCheckbox = styled((props) => <Checkbox {...props} />)`
  margin-right: 1rem;
...
export const ClosePopover = styled((props) => <CloseOutlined {...props} />)`
