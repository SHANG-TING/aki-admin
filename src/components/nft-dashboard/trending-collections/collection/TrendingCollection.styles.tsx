...
export const OwnerText = styled((props) => <Text {...props} />)`
...
export const USDText = styled((props) => <Typography.Text {...props} />)`
  transition: all 0.5s ease;
...
export const BidButton = styled((props) => <Button {...props} />)`
  transition: all 0.5s ease;
  position: absolute;
  top: 20px;
  right: 20px;
...
export const Card = styled((props) => <NFTCard {...props} />)<CardInternalProps>`
  overflow: hidden;
