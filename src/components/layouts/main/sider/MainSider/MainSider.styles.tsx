...
export const Sider = styled((props) => <Layout.Sider {...props} />)`
  position: fixed;
  overflow: visible;
  right: 0;
  z-index: 5;
...
export const CollapseButton = styled((props) => <Button {...props} />)<{ $isCollapsed: boolean }>`
...
export const SiderLogoLink = styled((props) => <Link {...props} />)`
  display: flex;
  align-items: center;
  overflow: hidden;
  position: relative;
