...
export const FormItem = styled((props) => <BaseForm.Item {...props} />)`
...
export const LinkText = styled((props) => <Text {...props} />)`
...
export const SocialButton = styled((props) => <Button {...props} />)`
  font-size: ${FONT_SIZE.md};
  font-weight: ${FONT_WEIGHT.semibold};
  color: var(--primary-color);
...
export const BackIcon = styled((props) => <LeftOutlined {...props} />)`
  font-size: 0.75rem;
